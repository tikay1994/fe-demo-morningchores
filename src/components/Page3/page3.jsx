  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 mt-5">
      <div className="fixed md:flex md:flex-col md:my-40 my-10 mx-10 bottom-0 left-0 flex ">
        ...
        <button className="border-2 rounded-full h-10 w-10 mt-5">
          <svg class="h-5 w-5 ml-2" viewBox="0 0 32 32">
            <path
              fill="#d14836"
              d="M32 6v20c0 1.133-0.867 2-2 2h-2v-18.151l-12 8.617-12-8.617v18.151h-2c-1.135 0-2-0.867-2-2v-20c0-0.567 0.216-1.067 0.575-1.424 0.359-0.363 0.86-0.576 1.425-0.576h0.667l13.333 9.667 13.333-9.667h0.667c0.567 0 1.067 0.216 1.425 0.576 0.36 0.357 0.575 0.857 0.575 1.424z"
            ></path>
          </svg>
        </button>
      </div>
      <div className="mx-20 lg:mr-0 col-start-1 col-end-3">
      ...
      <div className="hidden lg:flex flex-col mr-20 pl-6">
        <a href="#">
          <img src="https://morningchores.com/wp-content/uploads/2020/01/How-to-Catch-Chickens-the-Easy-and-Not-So-Easy-Way-FI-550x367.jpg"></img>
          <p className="text-2xl hover:text-indigo-500">
            How to Catch Chickens the Easy and Not-So-Easy Way
          </p>
        </a>
        <a href="#">
          <img src="https://morningchores.com/wp-content/uploads/2019/10/New-Hampshire-Red-Chicken-Simple-Birds-for-the-Practical-Farmer-FB-550x367.jpg"></img>
          <p className="text-2xl hover:text-indigo-500">
            New Hampshire Red Chicken: Simple Birds for the Practical Farmer
          </p>
        </a>
        <a href="#">
          <img src="https://morningchores.com/wp-content/uploads/2015/12/Best-Chicken-Breeds-for-Eggs-550x367.jpg"></img>
          <p className="text-2xl hover:text-indigo-500">
            Top 10 Chicken Breeds That Will Give You up to 300 Eggs per Year
          </p>
        </a>
        <a href="#">
          <img src="https://morningchores.com/wp-content/uploads/2019/02/About-Australorp-Chickens-Excellent-Egg-Layers-and-Barnyard-Pets-FB-550x367.jpg"></img>
          <p className="text-2xl hover:text-indigo-500">
