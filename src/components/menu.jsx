...
function Menu(props) {
  ...
  return (
    <div>
      <nav className="flex items-center justify-between mx-5 sm:mx-24 py-6 border-b-2">
        ...
        <div className="flex items-center">
          <div className="text-sm hidden lg:flex">
            <Link
              to="/page2"
              className="mt-1 text-base hover:text-teal-500 mx-4"
            >
              Homestead
            </Link>
            <a className="text-base mr-4">
